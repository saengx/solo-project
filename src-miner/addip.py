...
def banner():
	os.system("clear")
	print("\033[1;33;40m")
	os.system("figlet -f big SOLO")
	os.system("figlet -f big MINER")
	print("\033[00m\n")
...
while True:
    ...
    with open("setip/ip.json",encoding="utf-8") as set:
        ...
        print("file  =",file)
        print("\033[0m\n")
        print("\033[31mโปรดตรวจสอบการตั้งค่า ถ้าถูกต้อง ให้ใช้คำสั่ง  run  เพื่อเปิดขุด หรือ รอสักครู่ \033[0m")
        time.sleep(5)
        os.system("run")
    break
